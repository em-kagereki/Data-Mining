---
title: |
  Predicting the ICU admissions
type: Project report (HINF6210-DataMining)
author:
  - name: Edwin Kagereki
    affil: 
...
# Project dataset, Code, and Sample outputs.
...
This report is organized as follows. In section II, the report describes the project statement and objectives. In section III the report describes the solution to the problem including the dataset, code and the outputs. In Section IV, the analysis report is presented A short summary concludes the report.
...
# APPENDIX: R Code for perming data analysis
