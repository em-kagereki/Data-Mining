...
The Elbow method suggested `r elbow` components, the `r horn$n` suggested. However, `r Ninty` components (accounting for 90% of variance were however chosen) were selected for further analysis.
