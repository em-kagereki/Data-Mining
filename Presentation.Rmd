...
- Predicting likely outcome while the treatment is underway may help the clinicians make decisions proactively.
 - Syndromes Suggestive of Ischemia or Infarction
- Acute Coronary Syndrome (ACS) is a term given to diverse presentations related to cardiomyopathies of sudden onset.
...
- MIMIC-III is a large, freely-available database comprising deidentified healthrelated data associated with 46,520 patients who stayed in critical care units of the Beth Israel Deaconess
Medical Center between 2001 and 2012.

- Researchers seeking to use the database must:
1. Become a credentialed user on PhysioNet. This involves completion of a training course in human
subjects research.
...
- Although the database includes 26 tables, only the ADMISSIONS,PATIENTS,SERVICES,DIAGNOSIS_ICD,MICROBIOLOGYEVENTS,
PRESCRIPTIONS,PROCEDUREEVENTS_MV,D_ITEMS,D_LABITEMS`*`

.footnote[[*] This was enriched with the [Loinc tables](https://loinc.org/downloads/)]
